...
location = st.selectbox("Select a city", ('Banashankari', 'Basavanagudi', 'Mysore Road', 'Jayanagar',
...
listed_in_types = st.selectbox('list of restaurant',("Delivery",'Dine-out','Desserts','Cafes','Drinks & nightlife','Buffet','Pubs and bars'))
